...
def _run_flow() -> None:
    """Exécute les six étapes du flow Implicit de bout en bout."""
    with httpx.Client(follow_redirects=False, timeout=_HTTP_TIMEOUT) as http:
        ...
        print("  [4/6] authorize OK (id_token + access_token remis dans le fragment)")
        ...
        print(
            "  [5/6] collect OK (id_token vérifié + at_hash contrôlé + "
