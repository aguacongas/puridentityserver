"""Repository ApiResources en mémoire — implémentation monoprocess.
...
class InMemoryApiResourceRepository:
    """Maintient les ApiResources dans un dictionnaire en mémoire.
